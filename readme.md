...
To use rose-pine in gitui, follow the instructions outlined [here](https://github.com/gitui-org/gitui/blob/master/THEMES.md#configuration)


## Thanks to

- [LostinTimeandspaceYT](https://github.com/LostinTimeandspaceYT)
